    ...
    { inputs, ... }:
    {
      ...
      programs.plasma = {
            ...
            widgets = [
              {
                ...
                config = {
                  ...
                  ++ (if config.programs.steam.enable == true then "applications:steam.desktop" else [ ])
                  ++ [
        ...
        configFile = {
          ...
          "kwinrc"."NightColor"."Active" = (if config.hostSpec.hostName == "lixos" then false else true);
        ...
        // (
          if config.hostSpec.theme == "Tokyo Night" then
            ...
            { "kdeglobals"."General"."AccentColor" = "152,187,108"; }
        );
      };
    };
}
